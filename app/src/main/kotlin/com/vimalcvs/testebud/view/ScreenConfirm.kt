...
@Composable
fun ScreenConfirm(navController: NavController) {
    Scaffold(topBar = {
        TopAppBar(
...
fun ConfirmTransactionForm() {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Button(
                onClick = {
                    Toast.makeText(context, "OTP Send", Toast.LENGTH_SHORT).show()
                },
                modifier = Modifier
                    .padding(top = 28.dp)
                    .height(45.dp),
                colors = ButtonDefaults.buttonColors(
                    containerColor = Color(0xFF3629B7), contentColor = Color.White
                ),
...
fun ConfirmButton() {
    ...
    Button(
        onClick = {
            ...
            .fillMaxWidth()
            .height(52.dp), colors = ButtonDefaults.buttonColors(
            containerColor = Color(0xFF3629B7), contentColor = Color.White
        ), shape = RoundedCornerShape(16.dp)
    ) {
